...
class AlarmReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        Log.d("!", value1.toString())
        Log.d("!", value2.toString())
        Log.d("!", value3.toString())

        Log.d("!", intent.getBooleanExtra("alarm1",false).toString())
        Log.d("!", intent.getBooleanExtra("alarm2",false).toString())
        Log.d("!", intent.getBooleanExtra("alarm3", false).toString())
        ...
        if((cal.get(DAY_OF_WEEK) == value1)||(cal.get(DAY_OF_WEEK) == value2)||(cal.get(DAY_OF_WEEK) == value3) ){
            ...
            if (intent.getBooleanExtra("alarm1", false)) {
            ...
            if (intent.getBooleanExtra("alarm2", false)) {
            ...
            if (intent.getBooleanExtra("alarm3", false)) {
